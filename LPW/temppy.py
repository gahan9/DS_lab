...
class Iterator(object):
    ...
    def free_memory(self):
        ...
        no_of_records -= 1  # reserve accommodation for additional comparison block
    ...
    def total_records(self):
        # calculate total number of blocks by record size
        num_lines = sum(1 for line in open(self.data_one_path))
        no_of_records = num_lines - 1  # remove header line and last empty line
...
if __name__ == "__main__":
    table = Iterator(attribute_tuple=("name", "ssn", "gender", "job", "company", "address"),
                     data_one_path="data_one.dbf",
                     data_two_path="data_two.dbf")
