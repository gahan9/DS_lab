...
\paragraph{} Aim of this practical is to implement sort based two pass algorithm.
...
\inputminted[frame=lines, breaklines, linenos, fontsize=\small]{python}{../two_pass_sort_based.py}
